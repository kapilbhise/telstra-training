...
public class CaSignedCertificateGenerator {
    ...
    private static final int Issue_Years = CertificateUtils.Issue_Years;
    ...
    public X509Certificate createCertificate(String CERTIFICATE_ALIAS,String CERTIFICATE_DN) throws Exception{
        ...
        v3CertGen.setNotAfter(new Date(System.currentTimeMillis() + (1000L * 60 * 60 * 24 *365*Issue_Years)));
